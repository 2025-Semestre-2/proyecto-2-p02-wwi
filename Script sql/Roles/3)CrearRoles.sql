...
GRANT INSERT, UPDATE, DELETE ON SCHEMA::Sales       TO CORPORATIVO;      -- Invoices 
GRANT INSERT, UPDATE, DELETE ON SCHEMA::Purchasing  TO CORPORATIVO;      -- Suppliers 
GRANT INSERT, UPDATE, DELETE ON SCHEMA::Warehouse   TO CORPORATIVO;      -- StockItems
GO

-- Dar permisos, EXECUTE de forma granular:

EXEC sp_addrolemember 'CORPORATIVO', 'corp_analytics';
GO
